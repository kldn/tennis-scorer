...
The project root SHALL be a Cargo workspace containing at least two member crates: `tennis-scorer` (core library) and `tennis-scorer-api` (backend placeholder).
